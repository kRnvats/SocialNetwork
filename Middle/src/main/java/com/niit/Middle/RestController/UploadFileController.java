...
public class UploadFileController {
	...
	@Autowired
	private com.niit.Backend.Dao.UploadFileDao uploadFileDao;

	
	@Autowired
	private com.niit.Backend.service.UserService userService;
	...
	public void handleFileUpload(HttpServletRequest request, HttpSession session,
		...
		if (fileUpload != null) {
			...
			try {
				String path = "C:/Users/SAM SUNG/Oracle/Frontend/WebContent/resources/img/"
						+ user.getFirstName();
		 ...
		 try {
			    http.sendRedirect("http://localhost:8087/Frontend/index.html");
